  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
            ...
            <Button
              ...
              className={`h-auto p-4 flex flex-col items-center gap-2 ${
                carSpots === data.spots
                  ...
                  : "border-gray-300 text-primary hover:bg-surface-beige"
              }`}
            >
        ...
        <Card className="p-6 bg-surface-beige border-accent-pink">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="flex items-center justify-center">
          <Card className="p-6 bg-surface-beige">
              ...
              <div className="mb-4 flex justify-center">
                <div className="relative">
                  ...
                  >
                    <div className="absolute -top-16 left-0 right-0 flex flex-col items-center gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {Array.from({ length: Math.min(carSpots, 5) }, (_, i) => (
                          <div key={i} className="w-2 h-8 bg-primary mx-1 rounded-sm"></div>
                        ))}
                        {carSpots > 5 && <span className="text-sm text-primary font-bold mx-1">+</span>}
                        {/* Right outward arrow */}
                        <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                          <path
                            fillRule="evenodd"
                    ...
                    <div className="absolute -top-6 left-0 w-px h-3 bg-primary"></div>
                    <div className="absolute -top-6 right-0 w-px h-3 bg-primary"></div>

                    {/* Depth dimension line */}
                    <div className="absolute -left-8 top-0 bottom-0 w-px bg-primary"></div>
                    <div className="absolute -left-8 top-0 h-px w-3 bg-primary"></div>
                    <div className="absolute -left-8 bottom-0 h-px w-3 bg-primary"></div>

                    {/* Depth label */}
                    <div className="absolute -left-16 top-1/2 transform -translate-y-1/2 -rotate-90 text-sm text-primary font-medium whitespace-nowrap">
                      {depth}cm
                    </div>
                  </div>

                  {/* Width label */}
                  <div className="text-sm text-primary font-medium mt-3">{width}cm</div>
                </div>
              </div>

              <div className="text-sm text-secondary bg-amber-50 p-4 rounded-lg border-2 border-amber-300 shadow-sm">
